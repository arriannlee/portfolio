    ...
    >
      ...
      >
        ...
        >
          ...
          <span className="text-[var(--color-main)]"> TOGETHER</span>
        </h2>

        {/* SUBLINE */}
        <p className="font-body text-[var(--color-sub-text)] mt-4 text-base sm:text-lg">
        ...
        <div className="mt-10 flex gap-6 sm:gap-8">
          ...
          <a
            ...
            aria-label="LinkedIn"
            className="text-[var(--color-main)] hover:text-[var(--color-accent)] transition-colors motion-safe:hover:-translate-y-1"
          >
            <svg
